...
public class Bindings() {
    ...
    public VirtualAction GetAction(string name) => Actions.TryGetValue(name, out VirtualAction? value) ? value : throw new KeyNotFoundException("Attempting to access undefinined action binding");

    /// <summary>
    /// Remove a button input binding
    /// </summary>
    /// <param name="name">The binding name to remove.</param>
    /// <returns>The bindings object.</returns>
    ...
    /// <exception cref="KeyNotFoundException"></exception>
    public VirtualStick GetStick(string name) => Sticks.TryGetValue(name, out VirtualStick? value) ? value : throw new KeyNotFoundException("Attempting to access undefinined stick binding");
    ...
    /// <exception cref="KeyNotFoundException"></exception>
    public VirtualAxis GetAxis(string name) => Axis.TryGetValue(name, out VirtualAxis? value) ? value : throw new KeyNotFoundException("Attempting to access undefinined axis binding");
