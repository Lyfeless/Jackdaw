...
public class Nineslice {
    ...
    ExtendBehavior Extend;

    public Nineslice(string texture, RectInt center, ExtendBehavior extendBehavior = ExtendBehavior.TILE) : this(Assets.GetTexture(texture), center, extendBehavior) { }

    public Nineslice(Subtexture texture, RectInt center, ExtendBehavior extendBehavior = ExtendBehavior.TILE) {
    ...
    public void Render(Batcher batcher, RectInt bounds) {
        Render(batcher, bounds.Position, bounds.Size);
    }

    public void Render(Batcher batcher, Point2 position, Point2 size, bool constrainSize = true) {
